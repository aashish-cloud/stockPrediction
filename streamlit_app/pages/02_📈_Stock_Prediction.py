...
#####Combined Stock Prediction Graph#####
    
# Unpack the data
train, test, predict = combined_stock_prediction(stock_ticker)

# Check if the data is not None
if train is not None and (predictions >= 0).all():
    # Add a title to the stock prediction graph
    st.markdown("## **Combined Stock Prediction**")
